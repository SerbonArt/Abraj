...
public class AsrSetActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.asr_set_activity);

        TextView setTextView = findViewById(R.id.asr_set_text_view);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Asr Settings"); // Postavlja se naslov za Toolbar
