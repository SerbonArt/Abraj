...
public class DhuhrSetActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dhuhr_set_activity);

        TextView setTextView = findViewById(R.id.dhuhr_set_text_view);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Dhuhr Settings"); // Postavlja se naslov za Toolbar
