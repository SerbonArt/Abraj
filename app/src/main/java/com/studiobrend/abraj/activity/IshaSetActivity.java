...
public class IshaSetActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.isha_set_activity);

        TextView setTextView = findViewById(R.id.isha_set_text_view);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Isha Settings"); // Postavlja se naslov za Toolbar
