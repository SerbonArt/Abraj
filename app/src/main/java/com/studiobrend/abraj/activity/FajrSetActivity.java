...
public class FajrSetActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fajr_set_activity);

        TextView setTextView = findViewById(R.id.fajr_set_text_view);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Fajr Settings"); // Postavlja se naslov za Toolbar
